...
//	public $use_ssl = false; //removed in 1.8.3, see $sms->api property
    ...
    public ?string $send_datetime = null; // 1.8.4
    public string $error;
    public string $success;
    public array $status; // new in 1.7
    public array $info;
    public string $cost; // new in 1.8
    public string $balance; // new in 1.8
    ...
    public function send($to = false, $text = false, $from = false, $send_datetime = false)
    {
        ...
        {
            $this->send_datetime = date('Y-m-d H:i:s');
        }
        ...
        $result = $this->http_post($this->api, [
            'send' => $text,
